...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans antialiased">
      ...
      {/* Affiliate Program */}
      <section id="affiliates" className="py-20 bg-gradient-to-br from-rose-50 via-orange-50 to-amber-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            <span className="inline-flex items-center gap-2 text-sm font-semibold text-rose-600 uppercase tracking-wider bg-rose-100 px-4 py-1.5 rounded-full">
          ...
          <div className="mt-14 grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            {[
              {
                num: '01',
                titleKey: 'affiliate.step1Title',
                descKey: 'affiliate.step1Desc',
              ...
              {
                num: '02',
                titleKey: 'affiliate.step2Title',
                descKey: 'affiliate.step2Desc',
              ...
              {
                num: '03',
                titleKey: 'affiliate.step3Title',
                descKey: 'affiliate.step3Desc',
              ...
              <div key={step.num} className="relative bg-white rounded-2xl p-7 border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-start gap-4">
                  <div className={`flex-shrink-0 w-12 h-12 rounded-xl flex items-center justify-center ${step.color}`}>
                    {step.icon}
                  </div>
                  <div>
                    <div className="text-xs font-bold text-gray-300 tracking-widest mb-1">STEP {step.num}</div>
                    <h3 className="text-lg font-semibold text-gray-900">{t(step.titleKey as any)}</h3>
                    <p className="mt-1.5 text-sm text-gray-500 leading-relaxed">{t(step.descKey as any)}</p>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto">
            <div className="flex items-center gap-3 bg-white rounded-xl px-5 py-4 border border-rose-100 shadow-sm">
              <div className="w-10 h-10 bg-rose-100 rounded-xl flex items-center justify-center flex-shrink-0">
                <svg className="w-5 h-5 text-rose-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 14.25l6-6m4.5-3.493V21.75l-4.125-2.625-4.125 2.625-4.125-2.625L3 21.75V4.757c0-1.108.806-2.057 1.907-2.185a48.507 48.507 0 0 1 11.186 0c1.1.128 1.907 1.077 1.907 2.185Z" />
                </svg>
              </div>
              <div>
                <div className="text-lg font-bold text-gray-900">{t('affiliate.commissionBadge')}</div>
                <div className="text-xs text-gray-500">{t('affiliate.commissionDesc')}</div>
              </div>
            </div>
            <div className="flex items-center gap-3 bg-white rounded-xl px-5 py-4 border border-orange-100 shadow-sm">
              ...
              <div>
                <div className="text-lg font-bold text-gray-900">{t('affiliate.maxBadge')}</div>
                <div className="text-xs text-gray-500">{t('affiliate.maxDesc')}</div>
              </div>
            </div>
            <div className="flex items-center gap-3 bg-white rounded-xl px-5 py-4 border border-amber-100 shadow-sm">
              ...
              <div>
                <div className="text-lg font-bold text-gray-900">{t('affiliate.paymentBadge')}</div>
                <div className="text-xs text-gray-500">{t('affiliate.paymentDesc')}</div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-10 text-center">
            <Link
              ...
              className="inline-flex items-center gap-2 px-8 py-4 text-base font-semibold text-white bg-rose-500 rounded-xl hover:bg-rose-600 transition-all shadow-lg shadow-rose-500/25 hover:shadow-rose-500/40"
            >
            ...
            <p className="mt-3 text-sm text-gray-400">{t('affiliate.ctaNote')}</p>
          </div>
        </div>
      </section>
